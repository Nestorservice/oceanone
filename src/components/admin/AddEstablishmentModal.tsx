...
const AddEstablishmentModal: React.FC<AddEstablishmentModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Ajouter un établissement">
